...
export default class ModalPicker extends BaseComponent {
        ...
        return (
            <View key={catId} style={{width: width * 0.8 / this.props.data.length}}>
                <View style={{
                    ...
                    <Text style={{color: '#f9976c', fontSize: 20, fontFamily: Strings.iransans}}>{this.props.label[catId]}</Text>
                </View>
    ...
    renderCategory() {
        ...
        return (
            <View style={{flex: 1, height: '100%', justifyContent: 'center', marginTop: 25}}>
                <View style={{
                    flexDirection: 'row',
                ...
                <View style={{flexDirection: 'row', justifyContent: 'space-between',}}>
                    ...
                    <TouchableOpacity onPress={this.close}>
                        <View style={styles.cancelStyle}>
                            <Icon name={'x'} type={'feather'} color={Colors.milkWhite} size={25} />
                        </View>
                    </TouchableOpacity>

                    <TouchableOpacity onPress={this.accept}>
                        <View style={styles.acceptStyle}>
                            <Icon name={'check'} type={'feather'} color={Colors.milkWhite} size={25} />
                        </View>
                    </TouchableOpacity>
                </View>
